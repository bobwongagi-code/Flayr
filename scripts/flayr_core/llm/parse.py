...
from .comparison_contract import (
    _ALL_STAGE_CODES,  # noqa: F401 - explicit facade re-export
    _COMPARISON_SCOPES,  # noqa: F401 - explicit facade re-export
    _COMPARISON_SCOPE_ORIGINS,  # noqa: F401 - explicit facade re-export
    _IDENTITY_BASIS,  # noqa: F401 - explicit facade re-export
    _IDENTITY_CONFIDENCE,  # noqa: F401 - explicit facade re-export
    _IDENTITY_RELATIONS,  # noqa: F401 - explicit facade re-export
    _S5_FACT_SCOPE_SOURCE,  # noqa: F401 - explicit facade re-export
    _STAGE_COMPARISON_STATUSES,  # noqa: F401 - explicit facade re-export
    _SUBSTITUTION_RELATIONS,  # noqa: F401 - explicit facade re-export
        ...
        normalized_stages.append(
            {
                ...
                **{
                ...
                "model_severity": normalize_severity(item.get("model_severity") or item.get("severity")),
